...
robust_model1_lnSD <- robust(model1_lnSD, cluster = final_long$study, vcov = "CR2")
   ...
   p1 <-  orchard_plot(model1_lnCVR, group = "study", data = data_cvr, 
                 xlab = "log Coefficient of Variation Ratio (lnCVR)") + 
          labs(x = "Overall Mean Estimate") +
          theme(axis.text.y = element_blank(),
                legend.position = 'none')
   p2 <-  orchard_plot(model1_lnVR, group = "study", data = data_cvr, 
                 xlab = "log Variance Ratio (lnVR)") + 
