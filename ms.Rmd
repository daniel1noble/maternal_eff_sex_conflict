...
ggsave(plot = p4, filename = "fig1.pdf", path = "./output/figs", height = 7, width = 10, device = "pdf")
...
ggsave(plot = plot, filename = "fig2.pdf", path = "./output/figs", height = 7, width = 10, device = "pdf")
plot
```
