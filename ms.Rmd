...
###################
  ...
  robust_model1.3 <- robust(model1.3, cluster = data$study)
  
  # Use raw SSD for plotting, so we can ployt raw data, which is easier to interpret
...
p2 <- orchard_plot(model1.1, mod = "Int", xlab = "SMDH") + 
      scale_colour_manual(values = "grey") + 
      scale_fill_manual(values = "red") +
      labs(y = "Overall Meta-analytic Mean") +
...
Species with higher sperm intensity had a tendeny to have significantly larger effect sizes overall (overall meta-analytic mean: `r robust_model1.7_reparam$beta[1]`, 95% CI: `r robust_model1.7_reparam$ci.lb[1]` to `r robust_model1.7_reparam$ci.ub[1]`, p = `r p_value(robust_model1.7_reparam$pval[1])`; Figure \@ref(fig:sperm)). 
...
sperm_plot = ggplot(sperm_data, aes(x = SCR.SCI, y = SMDH)) + 
              ...
              geom_segment(aes(x = 1, y = 5.3, xend = 2, yend = 5.3), arrow = arrow(length = unit(0.1, "cm"), angle = 90, end = "both")) + 
